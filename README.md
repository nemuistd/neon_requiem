...
現在は MVP v0.1 を土台に、Phase 2 以降の拡張として 5アイドル・8施設・歌アップグレード・アイテム・記録に対応しています。
...
- ライブ時の注目アイドル `bond` 加算
- 基本リソース「灯るさ」
- アイドル「音羽 灯里」「朝霧 結」「響木 遠子」「深月 詩乃」「紙野 巡」
- 注目アイドル枠とアイドル切替
- 注目アイドル枠とアイドルタブでの交流値表示
- 解放済みアイドルによる全体パッシブ効果
- 未解放アイドルの解放条件表示
- 施設「路地裏ステージ」「ネオン掲示板」「薄明通り案内所」「仮設配信ブース」「記憶図書館」「録音保管庫」「古い放送室」「地下礼拝堂」
- 施設ごとの解放条件と強化
- 施設による灯るさの自動生産
