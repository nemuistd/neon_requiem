...
export const FACILITY_DEFINITIONS = defineContent([
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/01_alley-stage_rojiura-stage.png", import.meta.url).href,
    baseCost: 10,
    costMultiplier: 1.15,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/02_neon-board.png", import.meta.url).href,
    baseCost: 80,
    costMultiplier: 1.18,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/03_twilight-path-guide.png", import.meta.url).href,
    tags: ["infra"],
    baseCost: 3000,
    costMultiplier: 1.22,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/04_temporary-broadcast-booth.png", import.meta.url).href,
    baseCost: 55000,
    costMultiplier: 1.2,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/05_memory-library.png", import.meta.url).href,
    baseCost: 120000,
    costMultiplier: 1.2,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/06_recording-storage.png", import.meta.url).href,
    baseCost: 450000,
    costMultiplier: 1.18,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/07_old-broadcast-room.png", import.meta.url).href,
    baseCost: 500000,
    costMultiplier: 1.18,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/08_underground-plaza.png", import.meta.url).href,
    baseCost: 900000,
    costMultiplier: 1.18,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/09_name-record-wall.png", import.meta.url).href,
    tags: ["memory"],
    baseCost: 1100000,
    costMultiplier: 1.17,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/10_underground-chapel.png", import.meta.url).href,
    baseCost: 1800000,
    costMultiplier: 1.17,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/11_underground-passage-repair.png", import.meta.url).href,
    tags: ["infra"],
    baseCost: 3500000,
    costMultiplier: 1.16,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/12_restabilization-core.png", import.meta.url).href,
    tags: ["infra"],
    baseCost: 4200000,
    costMultiplier: 1.16,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/13_deep-layer-observatory.png", import.meta.url).href,
    tags: ["deep"],
    baseCost: 8000000,
    costMultiplier: 1.16,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/14_engineering-archive.png", import.meta.url).href,
    tags: ["deep"],
    baseCost: 22000000,
    costMultiplier: 1.15,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/15_prayer-engineering-ruins.png", import.meta.url).href,
    tags: ["deep"],
    baseCost: 60000000,
    costMultiplier: 1.15,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/16_reobservation-base.png", import.meta.url).href,
    tags: ["infra"],
    baseCost: 160000000,
    costMultiplier: 1.14,
  ...
  },
  {
    ...
    imageUrl: new URL("../../assets/facility-candidates/17_unnamed-theater.png", import.meta.url).href,
    baseCost: 450000000,
    costMultiplier: 1.14,
